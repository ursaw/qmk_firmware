...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT(
        ...
        KC_LSFT , KC_A   , KC_S   , KC_D   , KC_F   , KC_G,     KC_KB_MUTE,                          KC_H   , KC_J   , KC_K   , KC_L   , KC_SCLN, KC_QUOT,
        KC_LCTL , KC_Z   , KC_X   , KC_C   , KC_V   , KC_B,     KC_LGUI,  XXXXXXX,      MO(_LOWER),  KC_RGUI, KC_N   , KC_M   , KC_COMM, KC_DOT , KC_SLSH, KC_RSFT,
    ...
    [_RAISE] = LAYOUT(
        ...
        _______, KC_UNDO, KC_LGUI, KC_APP , KC_SPC  , KC_UNDS ,  _______, _______, _______, _______, KC_DEL , KC_BSPC, KC_LBRC, KC_RBRC, KC_BSLS  , _______,
                                              _______, _______, _______, _______, _______, _______, _______, _______
    ),
};
...
bool encoder_update_user(uint8_t index, bool clockwise) {
    if (index == 0) { /* First encoder */
        ...
        {
        case _RAISE:                           /* Navigate horizontal */
            if (clockwise) {
                tap_code(KC_LEFT);
            } else {
                tap_code(KC_RGHT);
        ...
        default:
            ...
            if (get_mods() & MOD_BIT(KC_LCTL)) {   /* audio volumne  */
                if (clockwise) {
