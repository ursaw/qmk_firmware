...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BL] = LAYOUT(
    ...
    KC_LCTL, KC_LGUI, KC_LALT, TG(_FK),  KC_SPC,          KC_NO,  KC_SPC, KC_RALT, KC_LEFT, KC_NO, KC_DOWN, RCTL_T(KC_RIGHT)
  ),
  ...
  [_FL] = LAYOUT(
    ...
    KC_CAPS, _______, KC_UP, _______,   _______, _______, _______, _______, _______, _______, KC_MPLY, KC_MPRV, KC_MNXT, KC_DEL, \
                        /* WASD for cursor */                    /* - - - -  VI for cursor  - - - - */ /* _ML */
    _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______, KC_LEFT, KC_DOWN, KC_UP  , KC_RIGHT ,_______, KC_GRAVE,\
