...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
    ...
    // no idea yet on which key to put TG(_FK) or MO(_FK)  - toggles layer, activating it if it’s inactive and vice versa
    [_FK] = LAYOUT(
   ...
   */
	...
	[_FL] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, KC_LGUI, KC_HOME, _______,            KC_PGDOWN, KC_END
        ),
