...
/*
 *    cd keyboards/handwired/dactyl_mnblckrtry/keymaps/ursaw
 *    qmk compile
 */
...
/*  variables for encoder app switch */
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT(
     ...
     [_LOWER] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, KC_0  , KC_0  ,KC_DOT , KC_EQUAL,                                 _______, XXXXXXX, KC_MUTE, KC_VOLD, KC_VOLU, XXXXXXX, XXXXXXX,
